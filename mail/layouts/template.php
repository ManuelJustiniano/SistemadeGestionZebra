                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	<img src="<?= $message->embed(Yii::getAlias('@webroot/assets_b/web/images/logo.png'))?>" style="max-width:600px;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent" mc:edit="footer_content00">
												<?php
												if($config['twitter']){
													echo "<a href=\"{$config['twitter']}\">Twitter</a>&nbsp;&nbsp;&nbsp;";
												}
												?>
                                                <?php
												if($config['facebook']){
													echo "<a href=\"{$config['facebook']}\">Facebook</a>&nbsp;&nbsp;&nbsp;";
												}
												?>
                                                <?php
												if($config['youtube']){
													echo "<a href=\"{$config['youtube']}\">Youtube</a>&nbsp;&nbsp;&nbsp;";
												}
												?>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top" class="footerContent" style="padding-top:0;" mc:edit="footer_content01">
                                                <em>Copyright &copy; <?= date("Y"); ?> <?= $config['nombre_empresa']; ?>, All rights reserved.</em>
                                                <br />
