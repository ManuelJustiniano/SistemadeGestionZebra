                ...
                if($(object).is('img')) {
                    if($(object).parent().hasClass('slickhoverWrapper') == false){
                        if(settings.animateIn) {    
                            ...
                            $(object).wrap('<div class="slickhoverWrapper" style="position: relative;  overflow:hidden; display:inline-block; background:'+settings.color+';"></div>');
                            $(icon).insertBefore($(object));
                        }
                        else
                            $(object).wrap('<div class="slickhoverWrapper" style="position: relative;  overflow:hidden; display:inline-block; background:url('+settings.icon+') center center no-repeat '+settings.color+';"></div>');        
                    }
                }
            },
