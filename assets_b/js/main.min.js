    ...
    var o = {
        initialised: !1, mobile: !1, init: function () {
            ...
            t.owlCarousel(e.extend(!0, {}, o, {
                ...
                navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'],
                autoHeight: !0
            })), e(".promo-slider").owlCarousel(e.extend(!0, {}, o, {
                lazyLoad: !0,
                navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'],
                autoHeight: !0
            })), e(".noticia-slider").owlCarousel(e.extend(!0, {}, o, {
                lazyLoad: !0,
                navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'],
                autoHeight: !0
                    ...
                    e.magnificPopup.open({
                        ...
                        callbacks: {
                            ajaxContentAdded: function () {
                                o.owlCarousels(), o.quantityInputs(), "undefined" != typeof addthis ? addthis.layers.refresh() : e.getScript("https://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b927288a03dbde6")
