...
class StringValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = Yii::t('yii', '{attribute} debe contener al menos {min, number} {min, plural, one{character} other{characters}}.');
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = Yii::t('yii', '{attribute} debe contener al menos {max, number} {max, plural, one{character} other{characters}}.');
        }
