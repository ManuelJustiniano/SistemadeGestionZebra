        ...
        <div class="container-fluid py-2">
            <div class="app-header-content">
                <div class="row pnarrlrow">
                    ...
                    <div class="app-utilities col-auto pnarrl">
                        ...
                        <div class="app-utility-item app-user-dropdown dropdown">
                            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><span><?php echo $user['usuario'] ?></span></a>
<ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
    <li><a class="dropdown-item" href="<?= Url::to(['cuenta/updateperfil']) ?>">Editar Perfil</a></li>
    <li><hr class="dropdown-divider"></li>
    <li><a class="dropdown-item" href="<?= Url::to(['cuenta/changepasswordperfil']) ?>">Cambiar contraseña</a></li>
    <li><hr class="dropdown-divider"></li>
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            ...
            echo Menu::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'Mi cuenta', 'url' => ['/cuenta/cuenta'], 'options' => ['class' => 'nav-item'],],
